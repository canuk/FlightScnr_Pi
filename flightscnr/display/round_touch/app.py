...
class RoundTouchDisplay:
    ...
    def _idle_clock_holds_screen(self) -> bool:
        ...
        return (
            ...
            and self.screen in (SCREEN_CLOCK, SCREEN_ANALOG_CLOCK, SCREEN_ANALOG_NIGHT, SCREEN_FLIEGER_CLOCK, SCREEN_FORECAST, SCREEN_COVERAGE)
    ...
    def _open_screen(self, screen: str):
        if screen in (SCREEN_CLOCK, SCREEN_ANALOG_CLOCK, SCREEN_ANALOG_NIGHT, SCREEN_FLIEGER_CLOCK, SCREEN_FORECAST, SCREEN_COVERAGE):
            self._last_clock_minute = -1
            self._last_clock_draw = 0.0
        previous = self.screen
    ...
    def _apply_brightness(self):
        ...
        # should apply uniformly across all screens, radar included.
            ...
            and self.screen
            not in (SCREEN_CLOCK, SCREEN_ANALOG_CLOCK, SCREEN_ANALOG_NIGHT, SCREEN_FLIEGER_CLOCK, SCREEN_FORECAST, SCREEN_COVERAGE)
        ):
            pct = day_pct
    ...
    def _handle_navigation(self):
        ...
        if swipe != input_handler.SWIPE_NONE and self.screen not in (
            ...
            SCREEN_FLIEGER_CLOCK, SCREEN_FORECAST, SCREEN_COVERAGE,
        ):
            self._note_activity()
    ...
    def _tick_timeout(self):
        ...
        if (
            self.screen in (SCREEN_CLOCK, SCREEN_ANALOG_CLOCK, SCREEN_ANALOG_NIGHT, SCREEN_FLIEGER_CLOCK, SCREEN_FORECAST, SCREEN_COVERAGE)
        ...
        if timeout_s is None:
            ...
            if self.screen in (SCREEN_CLOCK, SCREEN_ANALOG_CLOCK, SCREEN_ANALOG_NIGHT, SCREEN_FLIEGER_CLOCK, SCREEN_FORECAST, SCREEN_COVERAGE):
    ...
    def _tick_clock(self):
        if self.screen not in (SCREEN_CLOCK, SCREEN_ANALOG_CLOCK, SCREEN_ANALOG_NIGHT, SCREEN_FLIEGER_CLOCK, SCREEN_FORECAST, SCREEN_COVERAGE):
            return
        now = time.time()
    ...
    def run(self):
        ...
        try:
            while running:
                ...
                elif self.screen in (SCREEN_CLOCK, SCREEN_ANALOG_CLOCK, SCREEN_ANALOG_NIGHT, SCREEN_FLIEGER_CLOCK, SCREEN_FORECAST, SCREEN_COVERAGE):
                    self._tick_clock()
                elif self.screen in (SCREEN_TRACKED, SCREEN_LIVE):
